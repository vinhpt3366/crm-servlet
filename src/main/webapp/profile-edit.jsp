                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material"
									action="${pageContext.request.contextPath}/profile-edit?id=${task.id}" method="post"
                            >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <c:forEach var="item" items="${taskStatus}" varStatus="status">
												<option value="${item.getStatusID()}"
													<c:if test="${item.getStatusID() == task.statusID}">selected</c:if>>${item.getStatusName()}</option>
											</c:forEach>
                                        </select>
