			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="${pageContext.request.contextPath}/project-add" class="btn btn-sm btn-success">Thêm
							mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
									...
									<tbody>
										...
										<c:forEach var="project" items="${projects}" varStatus="status">
											<tr>
												...
												<td><a href="${pageContext.request.contextPath}/project-edit?id=${project.id}" class="btn btn-sm btn-primary">Sửa</a> 
												<a
													href="${pageContext.request.contextPath}/projects?deleteID=${project.id}"
