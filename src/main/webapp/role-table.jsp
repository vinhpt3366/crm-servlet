		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
					<li style="padding: 10px 0 0;"><a  href="${pageContext.request.contextPath}/"
			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="${pageContext.request.contextPath}/role-add" class="btn btn-sm btn-success">Thêm
							mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
									...
									<tbody>
										...
										<c:forEach var="role" items="${roles}" varStatus="status">
											<tr>
												...
												<td><a href="${pageContext.request.contextPath}/role-edit?id=${role.id}" class="btn btn-sm btn-primary">Sửa</a>
													<a
													href="${pageContext.request.contextPath}/roles?deleteID=${role.id}"
