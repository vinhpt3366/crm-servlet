						...
						<div class="white-box">
							...
							class="form-horizontal form-material">
								<div class="form-group">
									...
									<div class="col-md-12">
										<!-- <select class="form-control form-control-line">
										 ...
										 -->
										<select class="form-control form-control-line" name="projectID" required>
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" placeholder="Tên công việc" name="taskName" required
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<!-- <select class="form-control form-control-line">
										 ...
										 <select class="form-control form-control-line" name="assigneeID" required>
